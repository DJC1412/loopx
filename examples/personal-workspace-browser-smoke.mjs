...
const scenarioCatalog = [navigationSortingScenario, chatRecoveryScenario, loopxModeScenario, typedActionsScenario, teamPlanScenario, stewardJourneyScenario, executionChipScenario, progressiveLoadingScenario];
