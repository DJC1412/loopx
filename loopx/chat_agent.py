...
def _turn_prompt(
    ...
    *,
    ...
    return (
        ...
        "Repository-artifact routing metadata is advisory: a failed read alone is not a handoff request. Only an explicit implementation, execution-based validation, or extended-investigation request may use its exact recommended_handoff. "
